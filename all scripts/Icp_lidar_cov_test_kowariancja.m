...
image2=image2<10;
liczba_pentli=1500;
init_y=15.43333333*15/21;
init_x=15.933333*15/21;
...
map=robotics.BinaryOccupancyGrid(image2,21);  %% kwadrat 12 kolo 21
% Create lidar sensor
lidar = LidarSensor;
...
%Komp ma³y
save('C:\Users\Admin\Dysk Google\AKADEMIA\programy\MATLAB\skrypty\doktorat\symulacja_duza\dane\500_icp_kwadrat.mat','icp0o','icp1o','icp2o','icp3o','icp4o');
disp("wykonano");
rng(prev);
