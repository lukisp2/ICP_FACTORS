...
MagInset(h1, -1, [min_x1 max_x1 min_y1 max_y1], [10 10+diff_x1 5 5+skala1], {'NW','NW';'SE','SE'});
set(gca,'FontSize',8,'FontAngle','italic','FontName','Times');

diff_x=max_x0-min_x0;
diff_y=max_y0-min_y0;
proporcja=diff_x/diff_y;
diff_x0=proporcja*skala1;

MagInset(h1, -1, [min_x0 max_x0 min_y0 max_y0], [25 25+diff_x1 5 5+skala1], {'NW','NW';'SE','SE'});
