...
%Komp ma³y
image2=imread('C:\Users\Admin\Dysk Google\AKADEMIA\programy\MATLAB\skrypty\Mobile Robotics Simulation Toolbox\code\examples\matlab\okrag2.pgm');
...
wRef(tVec < 50) = 1.396263401595461*0%%0.25;   % 1*1.39626340159546 jest równe 8 stopni
wRef(tVec >=6.0) = 0.45;
wRef(tVec >=9.50) = 0.0;
...
%     best(i).ang=-1;
   ...
   % B=matrix1(:,:,i);
    ...
    %% ICP KLASIK
    rodzaj=0;
    [RotTransMat,data,model,Cov,iteracja,czas]=icpfunction(i,sigmaD,sigmaKK,skan,rodzaj);
    data=data;
    model=model;
...
%Komp ma³y
%save('C:\Users\Admin\Dysk Google\AKADEMIA\programy\MATLAB\skrypty\doktorat\symulacja_duza\dane\wiecej_iter_ok_obrot.mat','icp0o','icp1o','icp2o','icp3o','icp4o','icp0k','icp1k','icp2k','icp3k','icp4k')
